...
const CongressVotes = ({ formik }: Props) => {
      ...
      <Stack spacing={3}>
        ...
        >
          <Grid item xs={12} md={12}>
            ...
            >
              <Grid item xs={9} md={9}>
                <Typography>Total de Votantes</Typography>
              </Grid>
              <Grid item xs={3} md={3}>
                <TextField
                  fullWidth
              ...
              <Grid item xs={9} md={9}>
                <Typography>Papeletas Validas</Typography>
              </Grid>
              <Grid item xs={3} md={3}>
                <TextField
                  fullWidth
              ...
              <Grid item xs={9} md={9}>
                <Typography>Papeletas En Blanco</Typography>
              </Grid>
              <Grid item xs={3} md={3}>
                <TextField
                  fullWidth
              ...
              <Grid item xs={9} md={9}>
                <Typography>Papeletas Nulas</Typography>
              </Grid>
              <Grid item xs={3} md={3}>
                <TextField
                  fullWidth
